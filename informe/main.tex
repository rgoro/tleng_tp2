...
de la gramática.  Notamos en negrita los tokens y en negrita bastardilla los tokens con algún valor,
definidos más abajo.  $\\$
...
\fbox{
	\begin{minipage}{30em}
		...
		Constante $\rightarrow$ \textbf{const} \textit{\textbf{constante}} \textbf{=} \num\\
